import svgPaths from "./svg-5tbzz5fln1";
...
function Frame1() {
  return (
    <div className="bg-[#f689cd] h-[174.622px] overflow-clip relative rounded-[11.384px] shrink-0 w-[129px]">
      ...
      <div className="absolute backdrop-blur-[3px] bg-[rgba(255,255,255,0.2)] h-[175px] left-0 top-0 w-[129px]" />
      <button className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch cursor-pointer flex gap-[8px] items-center justify-center left-[calc(50%+0.5px)] rounded-[4px] size-[32px] top-[calc(50%-0.31px)]" data-name="Icon Button">
        <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Icon / Platform / Edit">
          <div className="absolute inset-[10%]" data-name="Union">
            <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
              <path clipRule="evenodd" d={svgPaths.p19a04340} fill="var(--fill-0, white)" fillRule="evenodd" id="Union" />
...
export default function Frame4() {
  return (
    <div className="bg-[#fafafc] content-stretch flex gap-[24px] items-start pl-[16px] pr-[24px] py-[16px] relative rounded-[24px] size-full">
      ...
      <Frame1 />
      <Frame2 />
      <button className="absolute content-stretch cursor-pointer flex gap-[8px] items-center justify-center left-[363px] opacity-0 rounded-[4px] size-[32px] top-[16px]" data-name="Icon Button">
